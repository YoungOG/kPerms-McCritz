...
public class ClearUserPrefixCommand extends BaseCommand {

    @Command(name = "clearuserprefix", aliases = {"clearuprefix", "removeuserprefix", "removeuprefix", "deleteuserprefix", "deleteuprefix"}, permission = "kperms.clearuserprefix")
        ...
        getProfileManager().requestProfile(uuid, new ProfileRequest<Profile>() {
            ...
            public void onComplete(Profile result) {
                ...
                if (profile != null) {
                    ...
                    MessageManager.sendMessage(sender, "&7The rank prefix for &c" + finalName + " &7has been cleared&7.");
                } else {
